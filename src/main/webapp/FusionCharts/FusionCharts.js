...
(function() {
	...
	g.core.addEventListener('Loaded', function(e) {
				var a = e.sender;
				if (a instanceof g.core
						&& a.__state.updatePending !== undefined) {
...
(function() {
	...
	f.extend({
				...
				clone : function(a, b) {
					...
					k(f.policies, c, this);
					k(f.renderer.getRendererPolicy(this.options.renderer), c,
							this);
					delete c.id;
					delete c.animate;
					delete c.stallLoad;
				...
				isActive : function() {
					if (!this.ref
							|| document.getElementById(this.id) !== this.ref
				...
				resizeTo : function(w, h, a) {
					...
					if (b.width && typeof b.width.toString === 'function') {
						this.width = b.width.toString().replace(
								lengthCleanupRegex, '')
					}
					if (b.height && typeof b.height.toString === 'function') {
						this.height = b.height.toString().replace(
								lengthCleanupRegex, '')
					}
					if (a !== true) {
				...
				window.attachEvent("onunload", function() {
							...
							for (var i = 0; i < a; i++) {
								listenersArr[i][0].detachEvent(
										listenersArr[i][1], listenersArr[i][2])
							}
...
(function() {
	...
	f.addEventListener('Loaded', function(a) {
				...
				if (!(b.ref && typeof b.ref.drawOverlayButton === 'function')) {
					f
							.raiseWarning(b, '04091602', 'run',
									'::LinkManager^Loaded',
									'Unable to draw overlay button on object. -'
											+ b.id);
					return
				}
				var c = f.extend({
