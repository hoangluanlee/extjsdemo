/*
 * ! FusionCharts Export Component JavaScript Library Copyright FusionCharts
 * Technologies LLP @license License Information at
 * <http://www.fusioncharts.com/license>
 * 
 * @author FusionCharts Technologies LLP @version: 1.0.3-release
 */
...
_FCEO.probeHandler = function(a) {
	...
	return _FCEO.L.isString(a) ? a : (a.parameters != null && _FCEO.L
			.isString(a.parameters.exportHandler))
...
_FCEO.updateComponent = function(b) {
	...
	var d = function(a) {
		return !_FCEO.L.isObj((b.srcObj.variables || b.srcObj.flashVars)[a],
				'undefined')
				? (b.srcObj.variables || b.srcObj.flashVars)[a]
